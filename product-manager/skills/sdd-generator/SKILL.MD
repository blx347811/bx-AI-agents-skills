...
name: sdd-generator
description: >
  Fills out the Solomon Partners Solution Design Document (SDD) template for a Copilot or AI agent.
  Use this skill whenever the user mentions SDD, Solution Design Document, wants to document a Copilot agent,
  ...
  and produces a fully populated .docx file using the standard SP template.
---

# SDD Generator

Populates the Solomon Partners SDD template (.docx) for a Copilot or AI agent.
...
```json
{
  ...
  "key_contacts": [
    {"role": "Process SME", "name": "Full Name", "email": "email@solomonpartners.com"},
    {"role": "Process Owner", "name": "Full Name", "email": "email@solomonpartners.com"},
  ...
  "prompt_logic": "Prompting strategy: system prompt purpose, context injection, RAG or chain-of-thought patterns.",
  "prompts": [
